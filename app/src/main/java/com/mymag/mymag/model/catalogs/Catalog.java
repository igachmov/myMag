...
public class Catalog {
    ...
    public static Catalog getInstance() {
        ...
        for (int i = 0; i < 200; i++)
            instance.addToCatalog(new Laptop("TestName " + i, "TestDescription " + i, rand.nextInt(10_000), rand.nextInt(100) + 1, Laptop.LaptopModel.ASUS, (rand.nextInt(6) + 1) * 4, 1000 + i, "TestCPU " + i, "OSY", 1995));
        return instance;
    }
